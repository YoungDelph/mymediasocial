package com.example.mymediasocial.Search;
...
import com.example.mymediasocial.utils.UserListAdapter;
...
//Query querys=reference.child(getString(R.string.dbname_users))
//        .orderByChild(getString(R.string.field_username)).startAt(keyword.charAt(1));
//Query queryss=reference.child(getString(R.string.dbname_users))
