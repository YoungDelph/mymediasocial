...
public class TextAdapter extends ArrayAdapter<Text> {
    ...
    public TextAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<Text> objects) {
...
//        }
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.text = (TextView) convertView.findViewById(R.id.image_caption);
        ...
        holder.post_text = getItem(position);
        ...
        holder.comments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "onClick: loading comment thread for " + getItem(position).getText_id());
                ((ProfileActivity)mContext).onCommentThreadSelected(getItem(position),
                        mContext.getString(R.string.profile_activity));

                //going to need to do something else?
                ((ProfileActivity)mContext).hideLayout();
...
//        imageLoader.displayImage(getItem(position).getImage_path(), holder.post_text);
...
//                    });
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener{
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            Log.d(TAG, "onDoubleTap: clicked on photo: " + mHolder.post_text.getText_id());
...
//                                    .removeValue();
    ...
    private void addNewLike(final ViewHolder holder){
        ...
        mReference.child(mContext.getString(R.string.dbname_texts))
                .child(holder.post_text.getText_id())
                .child(mContext.getString(R.string.field_likes))
                .child(newLikeID)
                .setValue(like);

        mReference.child(mContext.getString(R.string.dbname_user_photos))
                .child(holder.post_text.getUser_id())
                .child(holder.post_text.getText_id())
                .child(mContext.getString(R.string.field_likes))
                .child(newLikeID)
                .setValue(like);
    ...
    private void getLikesString(final ViewHolder holder){
        ...
        Log.d(TAG, "getLikesString: photo id: " + holder.post_text.getText_id());
        try{
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
            Query query = reference
                    .child(mContext.getString(R.string.dbname_texts))
    ...
    private void setupLikesString(final ViewHolder holder, String likesString){
        ...
        Log.d(TAG, "setupLikesString: photo id: " + holder.post_text.getText_id());
     ...
     * @return
     */
    private String getTimestampDifference(Text text){
        ...
        sdf.format(today);
        Date timestamp;
        final String photoTimestamp = text.getDate_created();
        try{
