...
public class VideoAdapter extends ArrayAdapter<Video> {
    ...
    public VideoAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<Video> objects) {
        ...
        for(Video video: objects){
            Log.d(TAG, "MainFeedListAdapter: video id: " + video.getVideo_id());
        }
    }
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.mVideoView = (TextureVideoView) convertView.findViewById(R.id.post_image);
...
//                            holder.mprofileImage);
    ...
    private void loadMoreData(){
        ...
        try{
            mOnLoadMoreItemsListener.onLoadMoreVideos();
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener{
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            Log.d(TAG, "onDoubleTap: clicked on photo: " + mHolder.video.getVideo_id());
...
//                                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
    ...
    private void setupLikesString(final ViewHolder holder, String likesString){
        ...
        Log.d(TAG, "setupLikesString: photo id: " + holder.video.getVideo_id());
